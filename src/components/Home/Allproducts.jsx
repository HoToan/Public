                            ...
                            <div className="block2">
                                ...
                                <div className="block2-txt flex-w flex-t p-t-14">
                                    <div className="block2-txt-child1 flex-col-l ">
                                        {/* <a href="/productdetail" className="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
                                                Esprit Ruffle Shirt
                                            </a> */}
                                        <NavLink to="/productdetail" className="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">Esprit Ruffle Shirt</NavLink>
                            ...
                            <div className="block2">
                                ...
                                <div className="block2-txt flex-w flex-t p-t-14">
                                    <div className="block2-txt-child1 flex-col-l ">
                                        ...
                                        <NavLink to="/productdetail" className="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">Herschel supply</NavLink>
                            ...
                            <div className="block2">
                                ...
                                <div className="block2-txt flex-w flex-t p-t-14">
                                    <div className="block2-txt-child1 flex-col-l ">
                                        ...
                                        <NavLink to="/productdetail" className="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">Only Check Trouser</NavLink>
                            ...
                            <div className="block2">
                                ...
                                <div className="block2-txt flex-w flex-t p-t-14">
                                    <div className="block2-txt-child1 flex-col-l ">
                                        ...
                                        <NavLink to="/productdetail" className="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">Classic Trench Coat</NavLink>
                            ...
                            <div className="block2">
                                ...
                                <div className="block2-txt flex-w flex-t p-t-14">
                                    <div className="block2-txt-child1 flex-col-l ">
                                        ...
                                        <NavLink to="/productdetail" className="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">Front Pocket Jumper</NavLink>
                            ...
                            <div className="block2">
                                ...
                                <div className="block2-txt flex-w flex-t p-t-14">
                                    <div className="block2-txt-child1 flex-col-l ">
                                        ...
                                        <NavLink to="/productdetail" className="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6"></NavLink>
