                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-md-8 col-lg-9 p-b-80">
                                <div className="p-r-45 p-r-0-lg">
                                    ...
                                    <div className="p-b-63">
                                        <a href="blog-detail" className="hov-img0 how-pos5-parent">
                                        ...
                                        <div className="p-t-32">
                                            <h4 className="p-b-15">
                                                <a href="blog-detail" className="ltext-108 cl2 hov-cl1 trans-04">
                            ...
                            <span className="cl12 m-l-4 m-r-6">|</span>
                                                ...
                                                <a href="blog-detail" className="stext-101 cl2 hov-cl1 trans-04 m-tb-10">
                                                    Continue Reading
